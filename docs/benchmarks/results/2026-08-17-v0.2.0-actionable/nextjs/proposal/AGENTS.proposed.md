...
<!-- source-digest: sha256:c021daf472ad2b93c8b067c2dd2be080b0da869a575873705c4285c2835ab6fd -->
<!-- content-digest: sha256:7e3799840105bed29f2a1a9dd14bb1f8f2955b363ce46a1fe0e4d5d82d16b20d -->
...
This pnpm monorepo contains the Next.js framework, its Turbopack and SWC implementations, test suites, examples, documentation, and maintenance scripts.

- Evidence: `AGENTS.md:9-19 (declares)`

#### Important areas

- `packages/next` - Houses the published Next.js package, including the dev server, production server, build entry points, source, and compiled output layout.
  - Evidence: `AGENTS.md:22-34 (declares)`

- `turbopack` - Houses the Rust Turbopack bundler subtree.
  - Evidence: `AGENTS.md:9-19 (declares)`

- `test` - Houses the repository test suites.
  - Evidence: `AGENTS.md:9-19 (declares)`

#### Related standards

- Related recipe: [Verify Next.js package types](.software-standards/verification/verify-next-package-types.yaml)
...
- Canonical rule: [.software-standards/rules/read-path-readmes-before-editing.md](.software-standards/rules/read-path-readmes-before-editing.md)
- Evidence: `AGENTS.md:44-53`

### Contextual semantic rules

#### [Treat unfiltered internal request headers as forgeable](.software-standards/rules/treat-unfiltered-internal-request-headers-as-forgeable.md) (`treat-unfiltered-internal-request-headers-as-forgeable`) - `always`

- Load when: `framework:nextjs`
- Applies to: `packages/next/src/server/**`
- Category: `security`
- Canonical rule: [.software-standards/rules/treat-unfiltered-internal-request-headers-as-forgeable.md](.software-standards/rules/treat-unfiltered-internal-request-headers-as-forgeable.md)
- Evidence: `AGENTS.md:508-512`

#### [Wire Next.js runtime flags across all consumers](.software-standards/rules/wire-next-runtime-flags-across-all-consumers.md) (`wire-next-runtime-flags-across-all-consumers`) - `always`

- Load when: `framework:nextjs`, `task:implementation`
- Applies to: `packages/next/src/**`
- Category: `correctness`
- Canonical rule: [.software-standards/rules/wire-next-runtime-flags-across-all-consumers.md](.software-standards/rules/wire-next-runtime-flags-across-all-consumers.md)
- Evidence: `AGENTS.md:464-470`

#### [Use Next.js test fixtures and polling conventions](.software-standards/rules/use-next-test-fixtures-and-polling-conventions.md) (`use-next-test-fixtures-and-polling-conventions`) - `always`

- Load when: `framework:nextjs`, `task:implementation`
- Applies to: `test/**`
- Category: `testability`
- Canonical rule: [.software-standards/rules/use-next-test-fixtures-and-polling-conventions.md](.software-standards/rules/use-next-test-fixtures-and-polling-conventions.md)
- Evidence: `AGENTS.md:150-161`, `AGENTS.md:180-184`, `AGENTS.md:198-225`

#### [Match Next.js test mode and bundler](.software-standards/rules/match-next-test-mode-and-bundler.md) (`match-next-test-mode-and-bundler`) - `always`

- Load when: `framework:nextjs`, `task:verification`
- Applies to: `packages/next/**`, `test/**`, `turbopack/**`
- Category: `testability`
- Canonical rule: [.software-standards/rules/match-next-test-mode-and-bundler.md](.software-standards/rules/match-next-test-mode-and-bundler.md)
- Evidence: `AGENTS.md:73-105`, `package.json:23-38`, `AGENTS.md:441-447`

#### [Keep pnpm security settings synchronized](.software-standards/rules/keep-pnpm-security-settings-synchronized.md) (`keep-pnpm-security-settings-synchronized`) - `always`

- Load when: `task:implementation`
- Applies to: `pnpm-workspace.yaml`, `scripts/install-native.mjs`, `test/lib/pnpm-security-settings.js`, `test/lib/create-next-install.js`
- Category: `security`
- Canonical rule: [.software-standards/rules/keep-pnpm-security-settings-synchronized.md](.software-standards/rules/keep-pnpm-security-settings-synchronized.md)
- Evidence: `pnpm-workspace.yaml:33-39`, `scripts/install-native.mjs:77-94`, `test/lib/pnpm-security-settings.js:1-3`, `test/lib/create-next-install.js:64-93`

### Verification commands

#### [Verify Next.js package types](.software-standards/verification/verify-next-package-types.yaml) (`verify-next-package-types`)
...
- Route when: `framework:nextjs`, `task:verification`
- Applies to: `packages/next/src/**/*.ts`, `packages/next/src/**/*.tsx`
- Category: `correctness`
- Canonical recipe: [.software-standards/verification/verify-next-package-types.yaml](.software-standards/verification/verify-next-package-types.yaml)
- Evidence: `packages/next/package.json:86-86`, `AGENTS.md:103-105`, `packages/next/tsconfig.build.json:4-22`
...
Expected result: TypeScript declaration compilation completes without errors.
