...
See [the rule format](docs/rule-format.md), [architecture](docs/architecture.md), and [primary-source research](docs/research/competitive-and-format-research.md).
